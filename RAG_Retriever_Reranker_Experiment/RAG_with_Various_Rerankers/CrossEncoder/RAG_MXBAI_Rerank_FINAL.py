...
class LegalRAGSystemMXBAI:
    ...
    def _setup_rag_components(self):
        print("⚙️ RAG 컴포넌트 설정 중 (MXBAI Reranker) ...")
...
def main():
    print("🚀 법률 문서 RAG 시스템 (MXBAI Reranker) 시작")
    print("=" * 60)
    try:
        rag_system = LegalRAGSystemMXBAI()

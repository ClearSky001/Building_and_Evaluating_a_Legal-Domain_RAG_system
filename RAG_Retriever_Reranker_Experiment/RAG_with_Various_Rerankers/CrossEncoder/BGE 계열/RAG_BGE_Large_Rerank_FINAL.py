"""
완전히 수정된 BGE Large 리랭커 - 모든 문제 해결
"""
import sys
import os
...
class LegalRAGSystemBGELarge:
    ...
    def _setup_rag_components(self):
        print("⚙️ RAG 컴포넌트 설정 중 (BGE Large Reranker) ...")
...
def main():
    print("🚀 법률 문서 RAG 시스템 (BGE Large Reranker) 시작")
    print("=" * 60)
    try:
        rag_system = LegalRAGSystemBGELarge()
